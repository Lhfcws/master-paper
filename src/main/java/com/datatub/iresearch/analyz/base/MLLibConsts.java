...
public class MLLibConsts {
    ...
    public static final String CLI_PARAM_NUM = "num";
    public static final String BASE = "base";
    public static final String INCR = "incr";
    public static final int UNCLASSIFY = - Integer.MAX_VALUE + 10;
    public static boolean isUnclassify(int classifyValue) {
        return MLLibConsts.UNCLASSIFY == classifyValue;
    }

    // Hornbill config
    //// FileSystem mode
    public static final String FS_MODE = "hornbill.filesystem.mode";
    ...
    public static final String FILE_SNT_RF_MODEL_BASE = "snt.rf.model.base";
    public static final String FILE_SNT_RF_MODEL_INCR = "snt.rf.model.incr";
    public static final String FILE_SNT_RF_CORPUS_BASE = "snt.rf.summarize.corpus.base";
    public static final String FILE_SNT_RF_CORPUS_INCR = "snt.rf.summarize.corpus.incr";
    public static final String FILE_SNT_LR_MODEL_BASE = "snt.lr.model.base";
    public static final String FILE_SNT_LR_MODEL1_BASE = "snt.lr.model1.base";
    public static final String FILE_SNT_LR_MODEL_INCR = "snt.lr.model.incr";
    public static final String FILE_SNT_LR_MODEL1_INCR = "snt.lr.model1.incr";
    public static final String FILE_SNT_LR_CORPUS_BASE = "snt.lr.summarize.corpus.base";
    public static final String FILE_SNT_LR_CORPUS_INCR = "snt.lr.summarize.corpus.incr";
    public static final String FILE_SNT_LR_CORPUS1_INCR = "snt.lr.summarize.corpus.incr";
    public static final String FILE_SNT_TMP_LIBSVM_PREFIX = "snt.tmp.libsvm.prefix";
    public static final String FILE_SNT_ACC_MODEL = "snt.accurate.model";
    public static final String PATH_SNT_MODEL_ROOT = "snt.model.path";
    ...
    public static final int MAX_SNT_TWT_WORDS = 1000;
    public static final int DEFAULT_CORPUS_SIZE = 100000;
    //// Split the data into training and test sets (30% held out for testing)
    public static final double[] DATA_SPLIT_RATIO = {0.7, 0.3};
