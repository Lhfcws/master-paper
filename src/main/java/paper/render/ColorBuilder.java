...
public class ColorBuilder {
    public static Color DEFAULT_COLOR = Color.GRAY.darker();
    ...
    public static void main(String[] args) {
        System.out.println(ColorBuilder.toRGBStr(Color.CYAN));
    }

    public static String toRGBStr(Color color) {
        return new StringBuilder().append(hex(color.getRed()))
                .append(hex(color.getGreen()))
                .append(hex(color.getBlue()))
                .toString();
    }

    private static String hex(int colorValue) {
    ...
    public static java.util.List<Color> generateGapColors(int _size) {
        java.util.List<Color> ret = new LinkedList<>();
        int size = _size > colorPool.length ? colorPool.length : _size;

        ret.addAll(Arrays.asList(colorPool).subList(0, size));

        while (ret.size() < _size)
            ret.add(DEFAULT_COLOR);
        return ret;
    }
